...
注解功能是 Google [AtScript](https://docs.google.com/document/d/11YUzC-1d0V1-Q3V0fQ7KSit97HnZoKVygDxpWzEYW0U/edit)https://docs.google.com/document/d/11YUzC-1d0V1-Q3V0fQ7KSit97HnZoKVygDxpWzEYW0U/edit 团队提出的，但并不是语言标准的一部分。然而，[Yehuda Katz 已经把 Decorator 已经作为了 ECMAScript 7 的一项提案](https://github.com/wycats/javascript-decorators)。可以用于在开发的时候注解和修改类和属性。
...
在使用 `@log` 之前，需要提前在应用的某个地方定义这个方法。因此先来看看 `log` **方法 Decorator** 的实现。
